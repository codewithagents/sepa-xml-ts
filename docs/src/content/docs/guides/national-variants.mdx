...
`pain.001.001.03` is not a national variant, it is the older ISO 20022 credit transfer format
...
The model input is the same `CreditTransferDocument` as for `.09`. Structural differences from
